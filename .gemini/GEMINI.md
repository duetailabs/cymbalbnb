# Preface
Before running any instructions on this application, Read the `.gemini/MIGRATE.md` file in its entirety.
...
Before starting any upgrade steps, refer to the `.gemini/MIGRATE.md` file in its entirety. If an `.upgrade/upgrade_plan.json` file exists, it represents the state of an in-progress upgrade and its steps should be followed.
